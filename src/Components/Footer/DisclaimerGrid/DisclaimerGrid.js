  ...
  return (
    <Grid item xs={12} sm={5} mt={7}>
      <Typography variant="DubaiRegular18" gutterBottom>
        ...
        other countries. VALCOM Properties is licensed as RDEXB Properties LLC.
        under RERA Registration Number 978060, 11th floor, O14 Tower, Marasi
        Drive, Business Bay, Dubai, UAE
      </Typography>
    </Grid>
  );
}
